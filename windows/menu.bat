...
echo   ╚══════════════════════════════════════════════════════════╝
echo.
echo   0) [?] Авто-подбор рабочей стратегии (РЕКОМЕНДУЕТСЯ)
echo   1) [i] Показать статус службы (zapret)
echo   2) [^>] Запустить службу
echo   3) [x] Остановить службу
echo   4) [~] Перезапустить службу
echo   5) [*] Сменить стратегию DPI Bypass (вручную)
echo   6) [-] Полное удаление проекта
echo   7) [!] Выход
echo.
